...
Except in some areas in Africa, most countries have the 2 lightest colors among the threshold, and the value is around 0.Therefore, the value of vote does have a strong relationship with Amazon ratings, and can been seen as a linear relation, although it's not strictly linear by some bias from the accurate 0.
